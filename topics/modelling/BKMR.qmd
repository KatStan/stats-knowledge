...
# The posterior inclusion probabilities (PIPs) cleary indicate that z2 should be
# included in the model, but there is not that strong evidence that z1 should be
...
# to 75th percentile increases by 0.68 when all other z are fixed at their 25th 
